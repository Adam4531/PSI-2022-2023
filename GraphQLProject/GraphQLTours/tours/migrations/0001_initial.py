# Generated by Django 4.1.2 on 2023-01-16 10:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reservations', to='tours.user')),
            ],
            options={
                'ordering': ('tour',),
            },
